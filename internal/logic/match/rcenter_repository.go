...
func (r *RCenterRepository) StartMatch(ctx context.Context, playerID int64, nickname, hero string, teamSize int) (*rcenter.MatchResult, error) {
	return r.client.StartMatch(ctx, playerID, nickname, hero, teamSize)
}
