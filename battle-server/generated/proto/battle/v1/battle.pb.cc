...
PlayerLoadout::PlayerLoadout(
  ...
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
           ...
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, player_id_),
           offsetof(Impl_, move_speed_level_) -
               offsetof(Impl_, player_id_) +
               sizeof(Impl_::move_speed_level_));
    ...
    if (this_._internal_attack_level() != 0) {
      target =
          ::google::protobuf::internal::WireFormatLite::WriteInt32ToArrayWithField<3>(
              stream, this_._internal_attack_level(), target);
    }
  }
    ...
    if (this_._internal_attack_speed_level() != 0) {
      target =
          ::google::protobuf::internal::WireFormatLite::WriteInt32ToArrayWithField<4>(
              stream, this_._internal_attack_speed_level(), target);
    }
  }
    ...
    if (this_._internal_health_level() != 0) {
      target =
          ::google::protobuf::internal::WireFormatLite::WriteInt32ToArrayWithField<5>(
              stream, this_._internal_health_level(), target);
    }
  }
