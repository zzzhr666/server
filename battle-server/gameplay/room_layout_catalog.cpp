    ...
    battle::RoomLayout make_combat_layout(std::string id, float half_extent,
        ...
        return battle::RoomLayout{
            ...
            .monster_spawn_points = {
                ...
                {half_extent - 6.0f, -half_extent + 7.0f}, {0.0f, half_extent - 10.0f},
                {-half_extent + 5.0f, -half_extent + 5.0f}, {half_extent - 5.0f, -half_extent + 5.0f},
                {-half_extent + 7.0f, half_extent - 10.0f}, {half_extent - 7.0f, half_extent - 10.0f},
            },
